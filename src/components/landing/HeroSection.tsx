      ...
      <div className="relative z-10 section-padding pb-8 md:pb-24 w-full max-w-3xl">
        ...
        <div className="flex items-center gap-5 flex-wrap mb-6">
          <button
            ...
            className="bg-accent text-accent-foreground px-10 py-4 text-sm tracking-wide uppercase font-medium shadow-lg"
          >
            Замовити зараз
          </button>
          <div className="flex flex-col">
            <span className="text-primary-foreground text-3xl font-semibold tracking-tight leading-none">
              2 250 ₴
            </span>
            <span className="text-primary-foreground/40 text-xs mt-1">
              повний костюм · худі + штани
            </span>
          </div>
        </div>
